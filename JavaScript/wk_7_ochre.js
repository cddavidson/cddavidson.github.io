...
document.addEventListener('DOMContentLoaded',
    ...
    function parseXML(sourceXML) {
      ...
      var property_table = document.getElementById('ochreTableBody');
      if (typeof(property_table) != 'undefined' && property_table != null) {
      ...
      var image_element = document.getElementById('preview');
      if (typeof(image_element) != 'undefined' && image_element != null) {
